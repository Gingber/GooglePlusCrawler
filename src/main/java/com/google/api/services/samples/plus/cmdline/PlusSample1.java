 ...
 */
public class PlusSample1 {

  /**
   * Be sure to specify the name of your application. If the application name is {@code null} or
   * blank, the application will log a warning. Suggested format is "MyCompany-ProductName/1.0".
   */
  private static final String APPLICATION_NAME = "GooglePlusProject";

  /** Directory to store user credentials. */
  private static final java.io.File DATA_STORE_DIR =
      new java.io.File(System.getProperty("user.home"), ".store/plus_sample_1");
  ...
  private static Credential authorize() throws Exception { 
	  ...
	  GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
			  new InputStreamReader(PlusSample1.class.getResourceAsStream("/client_secrets_.json")));
  ...
  private static void Crawler() throws IOException, SQLException{
      ...
      ArrayList<String> processuserId = TxtReader.loadVectorFromFile(new File("file/processed_userId.dat"), "UTF-8");
      
      for (int i = 0; i < userIdlist.size(); i++) {
    	  if (processuserId.contains(userIdlist.get(i))) {
    		  continue;
    	  } else {
    		  // run commands
    	      /** People   */
    	      People.listUserProfile(plus, userprofileCollection, userIdlist.get(i));
    	      ...
    	      /** Activities  */
    	      ArrayList<String> activitylist = Activities.listUserActivities(plus, activityCollection, userIdlist.get(i));
    	     ...
    	     /* View.header1("Get Activity's Comments");
    	      for (int j = 0; j < activitylist.size(); j++) {
    	    	  *//** Comments  *//*
    		      Comments.listUserComment(plus, commentCollection, activitylist.get(j));
    	      }*/
    	      
    	      TxtWriter.appendToFile(userIdlist.get(i), new File("file/processed_userId.dat"), "UTF-8");
    	  } 
      }
