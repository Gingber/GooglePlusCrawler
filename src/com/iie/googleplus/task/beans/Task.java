package com.iie.googleplus.task.beans;
...
public  class Task implements Serializable{
	public enum TaskType{
		About, Timeline, Follower, Followee, Search, Comment;
	...
	public String getURL(){
		...
		}else if(ownType==TaskType.Followee){
			return "/"+targetString+"/followee";
		}else if(ownType==TaskType.Follower){
			return "/"+targetString+"/follower";
