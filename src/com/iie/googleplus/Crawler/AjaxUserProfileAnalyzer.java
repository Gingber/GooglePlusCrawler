...
//			TxtWriter.saveToFile(data.toString(), new File("d:/data.txt"), "utf-8");
			
			int friends = 0;
			if(!data.getJSONArray(3).getJSONArray(0).isNull(0))  
				friends = data.getJSONArray(3).getJSONArray(0).getInt(0);
